...
- [] Set up MongoDB client and environment variables
- [] Configure ESLint and Prettier

## Authentication & User Management

- [] Implement NextAuth.js authentication with MongoDB (login/register)
...
- [] Create MongoDB database schema (users, rooms, questions, participants, answers)
